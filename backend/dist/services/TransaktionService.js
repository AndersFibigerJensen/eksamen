...
exports.updateTransaktion = exports.createTransaktion = exports.deleteTransaktionById = exports.GetTransaktion = exports.GetTransaktions = void 0;
const Transaktion_1 = require("../output/entities/Transaktion");
const data_source_1 = require("../data-source");
const TransaktionRepository = data_source_1.AppDataSource.getRepository(Transaktion_1.Transaktion);
    ...
    if (categoryId) {
        queryBuilder.andWhere((qb) => {
            const subQuery = qb
                ...
                .from(Transaktion_1.Transaktion, "Transaktion")
...
const addAccountFilter = (queryBuilder, AccountId) => {
    if (AccountId) {
        queryBuilder.andWhere((qb) => {
            const subQuery = qb
                .subQuery()
...
const addDateFiltering = (QueryBuilder, TransaktionDateHigh, TransaktionDateLow) => {
...
const addOrdering = (QueryBuilder, ordering) => {
    switch (ordering) {
        case "amountHigh":
...
const buildTransaktionQuery = (req) => {
    //get query params
...
const GetTransaktions = async (req) => {
...
exports.GetTransaktions = GetTransaktions;
const GetTransaktion = async (transaktionid) => {
    try {
...
exports.GetTransaktion = GetTransaktion;
const deleteTransaktionById = async (TransaktionId) => {
    try {
...
exports.deleteTransaktionById = deleteTransaktionById;
const createTransaktion = async (TransaktionData) => {
    const Transaktion = TransaktionRepository.create(TransaktionData);
    return await TransaktionRepository.save(Transaktion);
};
exports.createTransaktion = createTransaktion;
const updateTransaktion = async (TransaktionId, TransaktionData) => {
...
exports.updateTransaktion = updateTransaktion;
//# sourceMappingURL=TransaktionService.js.map